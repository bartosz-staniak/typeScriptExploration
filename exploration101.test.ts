...
test('1000,000,000 is close to 1000,000,000.005', () => { // fails as expected but somehow the calculated difference is > 0.005
  expect(1000000000).toBeCloseTo(1000000000.005); // Received difference: 0.005000000004656613
});